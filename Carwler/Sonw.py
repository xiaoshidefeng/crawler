...
#存在就删表重建
cursor.execute("DROP TABLE IF EXISTS SNOW")
...
def insert(commentTime,commentAuthor,commentContent):
    sqlorder = """INSERT INTO SNOW(COMMENT_TIME,COMMENT_AUTHOR,COMMENT_CONTENT) VALUES ('"""+commentTime+"'"+","+"'"+commentAuthor+"'"+","+"'"+commentContent+"')"
    try:
        # 执行sql语句
...
if __name__ == "__main__":
    ...
    initial_page = "http://www.wandoujia.com/apps/com.campmobile.snowcamera/comment"
    webheader = {
