...
#存在就删表重建
cursor.execute("DROP TABLE IF EXISTS MTXX")

# 创建表
sql = """CREATE TABLE MTXX (
...
def insert(commentTime,commentAuthor,commentContent):
    sqlorder = """INSERT INTO MTXX(COMMENT_TIME,COMMENT_AUTHOR,COMMENT_CONTENT) VALUES ('"""+commentTime+"'"+","+"'"+commentAuthor+"'"+","+"'"+commentContent+"')"
    try:
        # 执行sql语句
...
if __name__ == "__main__":
    ...
    initial_page = "http://www.wandoujia.com/apps/com.mt.mtxx.mtxx/comment"
    webheader = {
