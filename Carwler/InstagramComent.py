...
#存在就删表重建
cursor.execute("DROP TABLE IF EXISTS INSTAGRAM")
...
def insert(commentTime,commentAuthor,commentContent):
    sqlorder = """INSERT INTO INSTAGRAM(COMMENT_TIME,COMMENT_AUTHOR,COMMENT_CONTENT) VALUES ('"""+commentTime+"'"+","+"'"+commentAuthor+"'"+","+"'"+commentContent+"')"
    try:
        # 执行sql语句
...
if __name__ == "__main__":
    ...
    initial_page = "http://www.wandoujia.com/apps/com.instagram.android/comment"
    webheader = {
